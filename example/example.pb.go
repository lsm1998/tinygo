...
var file_example_proto_rawDesc = []byte{
	...
	,
}
...
var file_example_proto_depIdxs = []int32{
	0, // 0: demo.DemoApi.SayHello:input_type -> demo.SayHelloReq
	1, // 1: demo.DemoApi.SayHello:output_type -> demo.SayHelloRsp
...
func (c *demoApiClient) SayHello(ctx context.Context, in *SayHelloReq, opts ...grpc.CallOption) (*SayHelloRsp, error) {
	out := new(SayHelloRsp)
	err := c.cc.Invoke(ctx, "/demo.DemoApi/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedDemoApiServer) SayHello(context.Context, *SayHelloReq) (*SayHelloRsp, error) {
...
func _DemoApi_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SayHelloReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DemoApiServer).SayHello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/demo.DemoApi/SayHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DemoApiServer).SayHello(ctx, req.(*SayHelloReq))
	}
...
var _DemoApi_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SayHello",
			Handler:    _DemoApi_SayHello_Handler,
		},
	},
